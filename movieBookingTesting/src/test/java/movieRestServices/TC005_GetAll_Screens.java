...
public class TC005_GetAll_Screens extends TestBase{
	@BeforeClass
	public void getEmployees() {
		RestAssured.baseURI = config.getbaseURI();
		httpRequest = RestAssured.given();
		response = httpRequest.request(Method.GET,"screen/"+config.getmovieIdURI()+"/"+config.getDataFromConfig("theaterId"));
	}
