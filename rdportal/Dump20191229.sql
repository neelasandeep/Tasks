...
CREATE TABLE `employeedata` (
  ...
  `empfirstname` varchar(45) DEFAULT NULL,
  `yearofpass` float DEFAULT NULL,
...
INSERT INTO `employeedata` VALUES (1,'fss','dfd',2019,'hh','jj');
...
-- Dump completed on 2019-12-29 19:13:56
