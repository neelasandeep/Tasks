...
public class TC002_Get_All_Movies extends TestBase {

	@BeforeClass
	public void getEmployees() {
		RestAssured.baseURI = config.getMovieURI();
		httpRequest = RestAssured.given();
		response = httpRequest.request(Method.GET,config.getlocationIdURI());
	}
